...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
    ...
    public void handlePlayerPosLook(SPacketPlayerPosLook packetIn)
    {
        ...
        EventHandleTeleport e = new EventHandleTeleport(d0, d1, d2, f, f1, packetIn.getTeleportId());
        Client.onEvent(e);
        ...
        else if(!e.isCancellTeleporting())
        {
        ...
        if (packetIn.getFlags().contains(SPacketPlayerPosLook.EnumFlags.X_ROT) && !e.isCancellTeleporting())
        {
            f1 += entityplayer.rotationPitch;
        }

        if (packetIn.getFlags().contains(SPacketPlayerPosLook.EnumFlags.Y_ROT) && !e.isCancellTeleporting())
        {
