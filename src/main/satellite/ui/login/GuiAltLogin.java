...
public final class GuiAltLogin extends GuiScreen {
    ...
    public void drawScreen(int x2, int y2, float z2) {
    	this.buttonList.get(0).xPosition=width/2-104;
    	this.buttonList.get(0).setWidth(100);
    	this.buttonList.get(1).xPosition=width/2+4;
    	this.buttonList.get(1).setWidth(100);
    	
    	this.buttonList.get(0).yPosition=height/2;
    	this.buttonList.get(1).yPosition=height/2;
        ...
        if (this.multi.getText().isEmpty()) {
            this.drawString(this.mc.fontRendererObj, "Username:Password", width / 2 - 96, 26, -7829368);
        }
    ...
    public void initGui() {
        ...
        this.multi = new GuiTextField(var3, this.mc.fontRendererObj, width / 2 - 100, 20, 200, 20);
